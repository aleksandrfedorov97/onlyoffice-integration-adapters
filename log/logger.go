...
// Package log provides generic interface and implementations for
// logging.
//
// The log package's structures are self-initialized by fx and bootstrapper.
...
type Logger interface {
	// Writes a debug message with a specific format.
	Debugf(format string, args ...interface{})
	// Writes an info message with a specific format.
	Infof(format string, args ...interface{})
	// Writes a warning message with a specific format.
	Warnf(format string, args ...interface{})
	// Writes an error message with a specific format.
	Errorf(format string, args ...interface{})
	// Writes a fatal message with a specific format.
