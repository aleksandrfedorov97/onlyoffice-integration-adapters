...
//
// The rpc package's constructor is expected to be passed to a bootstrapper
// instance in order to be autoconfigured. A fully configured instance
// is ready to be used as a go-micro service.
package rpc
...
import (
	...
	"github.com/ONLYOFFICE/onlyoffice-integration-adapters/middleware/wrapper"
	"github.com/ONLYOFFICE/onlyoffice-integration-adapters/resilience"
...
// RPCMessageHandler a way to set up
...
// RPCEngine provides main ways of interactions with
// an rpc instance.
...
// A micro.Service constructor. Called automatically by fx
// if provided to a bootstrapper instance.
//
// Returns a fully configured and ready to use rpc based micro.Service.
// Panics on any error.
func NewService(
	engine RPCEngine,
